        ...
        >
          <div className="container-fm py-8">
            ...
            <div className="mt-4 flex items-center justify-between border border-volt/30 bg-gradient-to-r from-pitch to-pitch2 px-6 py-4">
              ...
              <Link to={(() => {
                const kitCat = allCategories.find(c => c.isKitBuilder)
                return kitCat ? `/shop?category=${kitCat.id}&customizable=1` : '/shop?customizable=1'
              })()} className="btn-volt !py-2 !text-xs">Customize Now</Link>
            </div>
          </div>
        </div>
      </div>
