...
import { Check, ChevronRight, CreditCard, Truck, Wallet } from 'lucide-react'
    ...
    return (
      <div className="container-fm grid place-items-center py-24 text-center">
        <div className="max-w-md">
          ...
          <p className="mt-3 text-muted">Order <span className="font-semibold text-volt">#FM-2026-{String(Math.floor(Math.random() * 9000) + 1000)}</span> is confirmed. A tracking link is on its way to your inbox.</p>
        ...
        <div className="border border-line bg-pitch p-6">
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <ul className="divide-y divide-line border border-line">
                {items.map((i) => (
                  <li key={i.key} className="flex items-center justify-between p-3 text-sm">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            {step < 3 ? (
              ...
              <button onClick={placeOrder} className="btn-volt !py-2.5 !text-xs">Place Order — {fmt(grand - shipping + shipFee)}</button>
            )}
          </div>
        </div>
        ...
        <aside className="h-fit border border-line bg-pitch p-6 lg:sticky lg:top-32">
          ...
          <dl className="mt-5 space-y-3 border-t border-line pt-5 text-sm">
            ...
            <div className="flex justify-between border-t border-line pt-3">
              ...
              <dd className="font-head text-xl font-semibold text-volt">{fmt(grand - shipping + shipFee)}</dd>
            </div>
          </dl>
