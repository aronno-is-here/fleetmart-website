...
const POLICIES = [
  ...
  { icon: <CreditCard size={20} />, title: 'Payments', text: 'Cash on Delivery, bKash, Nagad, Visa/Mastercard via SSLCommerz. Partial payment (৳300) available for online orders.' },
